...
const translations = {
  pl: {
    ...
    heroCarousel: {
      slides: [
        ...
        },
        {
          ...
          items: [
            { icon: 'Calendar', label: 'Rezerwacja online 24/7', desc: 'Pacjenci zapisują się sami — bez telefonu.' },
            { icon: 'Bell', label: 'Automatyczne przypomnienia SMS', desc: 'Redukcja no-shows nawet o 70%.' },
            { icon: 'Users', label: 'Samoobsługowa zmiana terminu', desc: 'Pacjent zmienia termin jednym kliknięciem.' },
            { icon: 'Sparkles', label: 'Inteligentne wypełnianie slotów', desc: 'Puste godziny wypełniają się same.' },
            { icon: 'Clock', label: 'Lista oczekujących z auto-powiadomieniem', desc: 'Mniej niż 15 min obsługi / tyg.' },
            { icon: 'Rocket', label: 'Wdrożenie w 14 dni', desc: 'Zero zmian w sprzęcie.' },
          ],
        },
        {
          type: 'system',
    ...
    form: {
      ...
      submit: 'Wyślij',
      bookCta: 'Umów wizytę',
      bookedSuccess: 'Dziękujemy! Skontaktujemy się z Tobą, aby umówić wizytę.',
      sending: 'Wysyłanie…',
  ...
  en: {
      ...
      slides: [
        {
          ...
          items: [
            ...
            { time: '12:30', label: 'J. Wiśniewski', status: 'booked' },
            { time: '13:00', label: 'SMS reminder', status: 'reminder' },
            { time: '14:30', label: 'K. Lewandowska', status: 'booked' },
        ...
        },
        {
          ...
          items: [
            { icon: 'Calendar', label: '24/7 online booking', desc: 'Patients book themselves — no phone call.' },
            { icon: 'Bell', label: 'Automatic SMS reminders', desc: 'No-shows reduced by up to 70%.' },
            { icon: 'Users', label: 'Self-service rescheduling', desc: 'Patients reschedule with one click.' },
            { icon: 'Sparkles', label: 'Smart slot filling', desc: 'Empty hours fill themselves.' },
            { icon: 'Clock', label: 'Waiting list with auto-notify', desc: 'Less than 15 min handling / week.' },
            { icon: 'Rocket', label: 'Deployment in 14 days', desc: 'No hardware changes.' },
          ],
        },
        {
          type: 'system',
    ...
    form: {
      ...
      bookedSuccess: 'Thank you! We\'ll contact you to schedule your visit.',
      sending: 'Sending…',
